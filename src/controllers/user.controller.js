...
const logoutUser = asyncHandler(async(req,res)=>{
    ...
    await User.findByIdAndUpdate(
        ...
        {
            $unset:{
                refreshToken: 1 // removing refresh token from database
            }
        },
        {
            new: true
...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
 ...
 const getCurrentUser = asyncHandler(async(req,res)=>{
    return res
    .status(200)
    .json(new ApiResponse(200,req.user,"current user  fetced sucessfully"))
 })
 ...
 const updateAccountDetails = asyncHandler(async(req,res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,user,"acccount deatail updated sucessfully "))
 })
 ...
 const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    if(!avatar.url){
        throw new ApiError(400,"Error while upoading file on avatar")
    }
 ...
 const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    if(!coverImage.url){
        throw new ApiError(400,"Error while upoading file on coverImage")
    }
